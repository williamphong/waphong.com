...
export const socialMedia = [
  ...
  },
  {
    ...
    link:'https://linkedin.com/williamphong'
  },
  {
    name:'Twitter',
...
export const experiencesData = [
  {
    ...
    location: 'CA, NV, MD',
    description:
      'Developed curriculum modules and preparation documents specialized for individual students and groups of 3-8. Coordinated with high schools, colleges, and staff for tournament logistics',
  ...
  },
  {
    ...
    description:
      'Assisted dozens of students daily by assessing their individual needs and learning styles, processed data for student information database',
...
export const projectsData= [
  ...
  },
  {
    ...
    description:
      "Generates a word cloud from a user's spotify daylist titles. Phrases are parsed from Spotify's API and saved.",
    tags: ['Python', 'Spotipy'],
  ...
  },
  {
    ...
    description:
      'Interviewed faculty administrators and students of CSUSM to determine a customer story and requirements. Utilized Java and Android Studio to develop front-end, employed a MySQL database and connector to communicate student data between server and application.',
  ...
  },
  {
    title: 'Discord Bot',
    description:
      'Implemented a Discord bot into servers with 200+ users. Utilized youtube-dl and ffmpeg to play audio in voice channels, and custom responses/behavior triggered through user commands. Hosted on a UNIX local machine with 24/7 up-time.',
    tags: ['Java', 'Python', 'C++' ],
