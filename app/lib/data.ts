...
export const projectsData: Project[] = [
  ...
  {
    title: 'waphong.com',
    description: 'Portfolio website developed using Next.JS, Typescript, and deployed using Vercel.',
